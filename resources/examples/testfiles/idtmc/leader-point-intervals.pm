...
const int K; // range of probabilistic choice
...
module process1
	...
	// pick value
	[pick] s1=0 -> [1/K, 1/K] : (s1'=1) & (p1'=0) & (v1'=0) & (u1'=true)
	             + [1/K, 1/K] : (s1'=1) & (p1'=1) & (v1'=1) & (u1'=true)
	             + [1/K, 1/K] : (s1'=1) & (p1'=2) & (v1'=2) & (u1'=true)
	             + [1/K, 1/K] : (s1'=1) & (p1'=3) & (v1'=3) & (u1'=true)
	             + [1/K, 1/K] : (s1'=1) & (p1'=4) & (v1'=4) & (u1'=true);
	// read
