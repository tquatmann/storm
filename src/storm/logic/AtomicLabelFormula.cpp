...
bool AtomicLabelFormula::isAtomicLabelFormula() const { return true; }

boost::any AtomicLabelFormula::accept(FormulaVisitor const& visitor, boost::any const& data) const { return visitor.visit(*this, data); }

std::string const& AtomicLabelFormula::getLabel() const { return label; }
