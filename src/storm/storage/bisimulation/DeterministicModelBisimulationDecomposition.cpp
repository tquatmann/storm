...
template<typename ModelType>
ModelType::ValueType DeterministicModelBisimulationDecomposition<ModelType>::computeIntervalProjection(ValueType intervalToSplitter, ValueType intervalToOtherBlocks) {
    if constexpr (storm::IsIntervalType<ValueType>) {
        // Normalize intervals
...
template class storm::storage::DeterministicModelBisimulationDecomposition<
