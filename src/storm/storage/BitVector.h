...
class BitVector {
   public:
    ...
    class const_reverse_iterator {
       ...
       private:
        ...
        // The index of the bit this iterator currently points to **plus 1**
   ...
   private:
     ...
     *
     * @note returns endIndex if no bit with value Value is present (even if Backward is true)
     *
     ...
     * @return The index of the found bit or endIndex in case no bit with Value is present in the searched range
     *
     */
