...
std::shared_ptr<storm::pgcl::PgclBlock> const& IfStatement::getIfBody() const { return this->ifBody; }
...
bool IfStatement::hasElse() const { return this->hasElseBody; }

storm::pgcl::BooleanExpression const& IfStatement::getCondition() const { return this->condition; }

void IfStatement::accept(storm::pgcl::AbstractStatementVisitor& visitor) { visitor.visit(*this); }
